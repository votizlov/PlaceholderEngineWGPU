...
// include: C:\Users\Admin\AppData\Local\Temp\tmpv56z4ptd.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'PlaceholderEngineWGPU/PlaceholderEngineWGPU.data';
      var REMOTE_PACKAGE_BASE = 'PlaceholderEngineWGPU.data';
...
Module['FS_createPath']("/", "E:", true, true);
Module['FS_createPath']("/E:", "git_projects", true, true);
Module['FS_createPath']("/E:/git_projects", "PlaceholderEngineWGPU", true, true);
Module['FS_createPath']("/E:/git_projects/PlaceholderEngineWGPU", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_PlaceholderEngineWGPU/PlaceholderEngineWGPU.data');

      };
      Module['addRunDependency']('datafile_PlaceholderEngineWGPU/PlaceholderEngineWGPU.data');
    ...
    loadPackage({"files": [{"filename": "E:/git_projects/PlaceholderEngineWGPU/resources/fourareen.mtl", "start": 0, "end": 308}, {"filename": "E:/git_projects/PlaceholderEngineWGPU/resources/fourareen.obj", "start": 308, "end": 5092043}, {"filename": "E:/git_projects/PlaceholderEngineWGPU/resources/fourareen2K_albedo.jpg", "start": 5092043, "end": 6496725}, {"filename": "E:/git_projects/PlaceholderEngineWGPU/resources/shader.wgsl", "start": 6496725, "end": 6498517}], "remote_package_size": 6498517});

  })();

// end include: C:\Users\Admin\AppData\Local\Temp\tmpv56z4ptd.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpl7bcbp98.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpl7bcbp98.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpujf8ujmv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpujf8ujmv.js
...
function findWasmBinary() {
    var f = 'PlaceholderEngineWGPU.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
